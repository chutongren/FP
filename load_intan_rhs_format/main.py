...
if __name__ == '__main__':
    ...
    # 2. 20s figure
    channel_selected = [6] # [0,1,4,5,6,7,8]  manual input 
    ...
    # 138, 95 selected
    peaks = find_peaks_in_data(data_selected20, peak_height=40) # ‘peak_height’ requires manual input, amp(spikes) > peak_height will be selected
    ...
    # channel 8: height=85/50,51, spikes_selected = [64878,134439, 184672, 251464, 351856, 410548, 428440, 475676, 485559, 594423] 
